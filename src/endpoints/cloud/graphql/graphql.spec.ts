...
describe(path.relative(process.cwd(), import.meta.filename), () => {
  for (const [version, endpoint] of [
    ...
    describe(`getTestExecution (${version})`, () => {
    ...
    describe(`getTestExecutions (${version})`, () => {
    ...
    describe(`addEvidenceToTestRun (${version})`, () => {
    ...
    describe(`removeEvidenceFromTestRun (${version})`, () => {
      const filename = "evidence.txt";
