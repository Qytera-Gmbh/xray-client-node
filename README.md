...
- [v1](https://docs.getxray.app/display/XRAY/v1.0)
  ...
  - [Test Plans](https://docs.getxray.app/display/XRAY/Test+Plans+-+REST)
    ...
    - [x] `POST   /rest/raven/1.0/api/testplan/{testPlanKey}/test`
    - [x] `DELETE /rest/raven/1.0/api/testplan/{testPlanKey}/test/{testKey}`
    - [x] `GET    /rest/raven/1.0/api/testplan/{testPlanKey}/testexecution`
    - [x] `POST   /rest/raven/1.0/api/testplan/{testPlanKey}/testexecution`
  ...
  - [Test Runs](https://docs.getxray.app/display/XRAY/Test+Runs+-+REST)
    ...
    - [x] `POST   /rest/raven/1.0/api/testrun/{id}/defect`
    - [x] `DELETE /rest/raven/1.0/api/testrun/{id}/defect/{issueIdOrKey}`
